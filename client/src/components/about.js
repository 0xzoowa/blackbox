      ...
      <article className="container mx-auto p-6 max-w-3xl min-h-[calc(100vh-64px-56px)]">
        ...
        <section className="mb-8">
          <p className="text-sm leading-relaxed  mb-4">
            ...
            but whose inputs and outputs are visible and can be observed. In
            other words, while you can see how the system behaves and interact
            with it, you cannot see or understand the mechanisms or logic inside
            it.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mb-4 text-sm leading-relaxed ">
            ...
            <li>
              <strong>Audience</strong>: Myself and anyone else who might find
              it helpful
            </li>
            <li>
